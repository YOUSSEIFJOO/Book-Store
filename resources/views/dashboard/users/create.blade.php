...
@section("body_content")
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form action="{{ route('dashboard.users.store', $user->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div style="width: 100px;height: 100px">
                        <img
                            src="{{ asset('upload_files/users/images/default.png') }}"
                            width="100%"
                            style="height: 100%"
                ...
                <div class="form-group">
                    ...
                    <label for="password">@lang("site.password_users") :- </label>
                    <input
                        type="password"
                        name="password"
                        id="password"
                        class="form-control margin @error('password') is-invalid @enderror"
                        placeholder="@lang('site.password_placeholder_users')"
                        value="{{ old('password') }}"
                        required
                    />
                    @error('password')
                ...
                {{-- The Password Confirmation Of Admin. --}}
                <div class="form-group">

                    <label for="password_confirm">@lang("site.password_confirm_users") :- </label>
                    <input
                        type="password"
                        name="password_confirmation"
                        id="password_confirm"
                        class="form-control margin @error('password_confirm') is-invalid @enderror"
                        placeholder="@lang('site.password_confirm_placeholder_users')"
