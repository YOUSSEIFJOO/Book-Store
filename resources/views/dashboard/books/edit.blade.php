        ...
        <div class="box-body">
            ...
            <form action="{{ route('dashboard.books.update', $book->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            ...
                            {{ $book->lang ==  __("site.arabic_book") ? "selected" : ""}}
                        >@lang("site.arabic_book")</option>

                        <option
                            value="@lang("site.translate_book")"
                            {{ $book->lang ==  __("site.translate_book") ? "selected" : ""}}
                ...
                <div class="form-group">
                    ...
                    <label for="book">@lang("site.file_books") :- </label>
                    <input
                        type="file"
                        name="file_book"
                        id="book"
                        class="form-control margin @error('book') is-invalid @enderror book"
                    />
                    <p class="book-preview"></p>
                    @error('book')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
