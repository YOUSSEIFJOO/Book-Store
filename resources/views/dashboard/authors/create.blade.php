...
@section("body_content")
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form action="{{ route('dashboard.authors.store', $author->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div style="width: 100px;height: 100px">
                        <img
                            src="{{ asset('upload_files/authors/images/default.jpg') }}"
                            width="100%"
                            style="height: 100%"
                ...
                <div class="form-group">
                    ...
                    <textarea
                        name="about_him"
                        id="about_him"
                        class="form-control margin @error('about_him') is-invalid @enderror"
                        style="height: 150px"
                        required
                    ></textarea>
                    @error('about_him')
